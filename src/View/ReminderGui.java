...
public class ReminderGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(196, 222, 194));
        setResizable(false);

        jLabel2.setText("Date for the Reminder");
        ...
        jLabel1.setText("Description of Reminder");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try{
        java.util.Date  mydate = jDateChooser1.getDate();
        java.sql.Date nuMydate = new Date(mydate.getTime());
        mR_date = nuMydate.toString();
       theReminder.createReminder(jTextArea1.getText(), mR_date);
        }catch(Exception e){
        e.printStackTrace();
        }
 ...
 public void activateFrame(JFrame frame){
